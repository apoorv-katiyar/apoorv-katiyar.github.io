...
function setStoredTheme(theme) {
  try {
    ...
    // Ignore storage issues in restricted/private browser modes
  }
}
...
Focused on CI/CD migrations, reusable
pipeline templates, and cloud automation.`,
    }),
...
☁️  Cloud: AWS, Terraform, CloudWatch
🔒 Security: SonarQube, Snyk, BlackDuck
📊 Monitoring: Prometheus, Grafana
💻 Scripting: Python, Linux, YAML`,
    }),
...
1. GitLab → GitHub Actions Migration
   → 3+ apps, zero downtime, 50% faster deployments
   
2. CPC Templates
   → Reusable build/test/security pipelines for 25+ teams
   
3. VP2 Templates
   → Zero-downtime frontend deployment automation
   
4. AWS + Kubernetes Automation
   → Terraform, monitoring, scaling, and security`,
    }),
...
Email:     Katiyar.apoorv97@gmail.com`,
    ...
    theme: () => {
      ...
      return {
        type: "success",
        text: `Theme: ${theme === "dark" ? "light" : "dark"} mode`,
      };
    },
    ...
    cat: (args) => {
      ...
      const files = {
        "about.txt": "DevOps Engineer @ Accenture | 4 Years | Bengaluru",
        "skills.txt":
          "GitHub Actions, GitLab CI/CD, Docker, Kubernetes, AWS, Terraform, Python, Linux, YAML",
        "contact.txt":
          "Email: Katiyar.apoorv97@gmail.com | Phone: +91 8960050564 | Bengaluru",
        "README.md":
          "# Apoorv Katiyar - DevOps Engineer\nSpecializing in CI/CD, cloud infrastructure, and automation",
        "awards.txt":
    ...
    neofetch: () => ({
      ...
      text: `
       ...
       ╚═╝  ╚═╝╚═╝     Stack: CI/CD, K8s, AWS
                       ...
                       Certs: KCNA, Docker, GitHub Actions`,
    }),
...
Key focus: CI/CD migration, reusable templates,
AWS automation, Kubernetes, and observability`,
    }),
...
✓ GitHub Actions Course - KodeKloud
✓ Docker Course - KodeKloud
✓ JIO Digital Championship Program (Platinum)`,
    }),
  };
...
function initContactForm() {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    submitBtn.innerHTML =
      '<span class="material-icons-round">hourglass_empty</span> Sending...';
    ...
    try {
      ...
      if (!hasConfiguredEndpoint) {
        status.textContent =
          "This form is not configured yet. Please email me directly at Katiyar.apoorv97@gmail.com.";
      ...
      if (response.ok) {
        ...
        form.reset();
        submitBtn.innerHTML =
          '<span class="material-icons-round">check_circle</span> Sent!';
        setTimeout(() => {
          submitBtn.innerHTML = originalBtnText;
          submitBtn.disabled = false;
        }, 3000);
